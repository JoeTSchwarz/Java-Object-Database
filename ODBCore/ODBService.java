...
public class ODBService implements Runnable {
  ...
  */
  public boolean forcedFreeKey(String dbName, String key) throws Exception {
    boolean b = odMgr.restoreKey("*", dbName, key, true);
  ...
  */
  public boolean forcedRollbackKey(String dbName, String key) throws Exception {
    boolean b = odMgr.restoreKey("*", dbName, key, false);
    if (b) parms.BC.broadcast(4, 
  ...
  */
  public boolean forcedFreeKeys(String dbName) throws Exception {
    ...
    if (b) parms.BC.broadcast(4, parms.webHostName+(char)0x01+"All keys of "+dbName+" is forced to unlock.", parms.nodes);
    return b;
  }
  /**
  ...
  */
  public boolean forcedRollback(String dbName) throws Exception {
    ...
    if (b) parms.BC.broadcast(4, parms.webHostName+(char)0x01+"All keys of "+dbName+" is forced to rollback.", parms.nodes);
    return b;
  }
  /**
