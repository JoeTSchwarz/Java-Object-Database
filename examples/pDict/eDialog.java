...
public class eDialog {
  public static eParms dialog(String title, String lab, String word, String meaning, boolean enable) {
    ...
    vbox.getChildren().addAll(tVb, ly, ta);

    dp.setContent(vbox);
    //dp.setPrefSize(400, 70);
