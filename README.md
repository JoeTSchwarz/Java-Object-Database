...
5) modify the oodb_ConfigNodeX: IP or HostName, Port
6) run the ODBServer either with SWING
   ...
   or mixed SWING/JFX
7) go to UserMainternance with the default Superuser with ID: admin and PW: system (both
...
8) run "java ThePeople" (People-Example) or "java eDict" (dDict/eDict/pDict-Example) etc. using your new´
